...
if (isset($_GET['id_keterampilan'])) {
    // ambil nilai id dari url dan disimpan dalam variabel $id
    $id_keterampilan = ($_GET["id_keterampilan"]);

    // menampilkan data mahasiswa dari database yang mempunyai id=$id
    $query = "SELECT * FROM keterampilan WHERE id_keterampilan='$id_keterampilan'";
    ...
    $id_keterampilan = $row["id_keterampilan"];
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form class="form-sample" action="proses-edit.php" method="post">
                                                    <input name="id_keterampilan" type="hidden" value="<?php echo $id_keterampilan; ?>" />
                                                    <div class="row">
                                                        <div class="col-md-6">
