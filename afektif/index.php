    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Table Afektif</h4>
			...
			<tr>
                ...
                $no=1;
                      while ($row = mysqli_fetch_array($query)) {
                        ...
                        echo "<td align='center'><a href='form-edit.php?id_user=$row[id_afektif]'>Edit</a> | <a href='delete.php?id_user=$row[id_afektif]'>Delete</a></td></tr>";     
                      $no++;
                      }
                      echo '
              </tbody>
