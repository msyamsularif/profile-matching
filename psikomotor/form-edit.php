...
if (isset($_GET['bobot_psikomotor'])) {
    // ambil nilai id dari url dan disimpan dalam variabel $id
    $bobot_psikomotor = ($_GET["bobot_psikomotor"]);

    // menampilkan data mahasiswa dari database yang mempunyai id=$id
    $query = "SELECT * FROM psikomotor WHERE bobot_psikomotor='$bobot_psikomotor'";
    ...
    $bobot_psikomotor = $row["bobot_psikomotor"];
    $range_penilaian_psikomotor = $row["range_penilaian_psikomotor"];
} else {
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-12 grid-margin">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Edit Data Psikomotor</h4>
                                                <br />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="range_penilaian_psikomotor" class="form-control" value="<?php echo $range_penilaian_psikomotor; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="bobot_psikomotor" class="form-control" value="<?php echo $bobot_psikomotor; ?>" readonly/>
                                                                </div>
                                                            </div>
                                                        </div>
