                    ...
                    <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                      <div class="row">
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                          echo "<tr>";
                          echo "<td>" . $no . "</td>";
                          echo "<td>" . $row['range_penilaian_psikomotor'] . "</td>";
                          echo "<td>" . $row['bobot_psikomotor'] . "</td>";
                          echo "<td align='center'><a href='form-edit.php?bobot_psikomotor=$row[bobot_psikomotor]'>Edit</a> | <a href='delete.php?bobot_psikomotor=$row[bobot_psikomotor]'>Delete</a></td></tr>";
                          $no++;
                        }
                        echo '
                        </tbody>
