                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="range_penilaian_kognitif" class="form-control" value="<?php echo $range_penilaian_kognitif; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="bobot_kognitif" class="form-control" value="<?php echo $bobot_kognitif; ?>" disabled/>
                                                                </div>
                                                            </div>
                                                        </div>
