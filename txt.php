								...
								<div class="card">
									<div class="card-body">
										...
										<div class="alert alert-danger container">
											...
											<p>penambahan data hanya bisa dilakukan satu kali saat pengisian nilai, pastikan data yang di input sudah benar</p>
										</div <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
										<div class="row">
											...
											while ($rows = mysqli_fetch_array($query)) {
												...
												while ($row = mysqli_fetch_array($query_jadwal)) {
													...
													<td><input type="text" name="tugas" /><input type="" readonly="" value="Nilai (<?php echo $row['tugas']; ?>)" class="form-control text-center" /></td>
													</td>
											<?php
